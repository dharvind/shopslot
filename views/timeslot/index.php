    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'value' => function ($model) {
                    if($model->count < $model->shop->max_per_slot) {
                        ...
                        return $model->shop->name.': '.date('Y-m-d H:i',strtotime($model->start_timestamp)).' to '.date('H:i',strtotime($model->end_timestamp)) . ' (Full)';
                    }
                },
            ],
            [
